                    ...
                    <div id="lista-catalogo">
                            ...
                            <div class="item-catalogo" id="item-catalogo">
                                <div class="categoria-{{$cat->id}}" id="categoria">
                                    <div class="borda" data-toggle="collapse" role="button" id="produto-colapsado" aria-expanded="false" href="#collapseProduct{{$cat->id}}" aria-controls="collapseProduct1" class="category-collapsed bg-white py-15 px-20 bb-1-gray pointer collapsed">
                                        <span>{{$cat->categoria}}</span><span class="mais">+</span>
                        ...
                        <div class="col-12" id="menu-pedido">
                            <div class="">
                                ...
                                <div>
                                    ...
                                    <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FNewBistroivoti&tabs=timeline&width=340&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" 
                                        width="340" height="340" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                                </div>
                                <hr>
                                <div>
